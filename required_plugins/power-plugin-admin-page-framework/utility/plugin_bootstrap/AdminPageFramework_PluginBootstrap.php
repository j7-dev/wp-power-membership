...
abstract class PowerPlugin_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    {
        if (! class_exists('PowerPlugin_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new PowerPlugin_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
