...
class PowerPlugin_AdminPageFramework_PointerToolTip extends PowerPlugin_AdminPageFramework_FrameworkUtility {
    ...
    {
        echo "<script type='text/javascript' class='power-plugin-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->___getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
