...
class PowerPlugin_AdminPageFramework_FrameworkUtility extends PowerPlugin_AdminPageFramework_WPUtility {
    ...
    {
        $_sVersion = PowerPlugin_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    public static function getFrameworkName()
    {
        return PowerPlugin_AdminPageFramework_Registry::NAME;
    }
