...
class PowerPlugin_AdminPageFramework_Debug extends PowerPlugin_AdminPageFramework_Debug_Log {
    ...
    {
        self::showDeprecationNotice('PowerPlugin_AdminPageFramework_Debug::' . __FUNCTION__, 'PowerPlugin_AdminPageFramework_Debug::dump()');
        PowerPlugin_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    public static function getArray($asArray, $sFilePath=null, $bEscape=true)
    {
        self::showDeprecationNotice('PowerPlugin_AdminPageFramework_Debug::' . __FUNCTION__, 'PowerPlugin_AdminPageFramework_Debug::get()');
        return PowerPlugin_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    public static function logArray($asArray, $sFilePath=null)
    {
        self::showDeprecationNotice('PowerPlugin_AdminPageFramework_Debug::' . __FUNCTION__, 'PowerPlugin_AdminPageFramework_Debug::log()');
        PowerPlugin_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
}
