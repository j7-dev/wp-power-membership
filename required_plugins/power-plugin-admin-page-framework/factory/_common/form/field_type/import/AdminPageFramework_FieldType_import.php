...
class PowerPlugin_AdminPageFramework_FieldType_import extends PowerPlugin_AdminPageFramework_FieldType_submit {
    ...
    {
        return array( array( 'handle_id' => 'power-plugin-field-type-import', 'src' => dirname(__FILE__) . '/js/import.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'power-plugin-script-form-main' ), 'translation_var' => 'PowerPlugin_AdminPageFrameworkImportFieldType', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array( 'noFile' => $this->oMsg->get('import_no_file'), ), ), ), );
    }
