...
var apfImage = PowerPlugin_AdminPageFrameworkImageFieldType;
apfImage.hasMediaUploader = !! apfImage.hasMediaUploader;
(function ( $ ) {

  var setPowerPlugin_AdminPageFrameworkImageUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfImage.hasMediaUploader ) {
       ...
       */
      setPowerPlugin_AdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function () {
          ...
          window.send_to_editor = hfPowerPlugin_AdminPageFrameworkSendToEditorImage;
      ...
      var hfPowerPlugin_AdminPageFrameworkSendToEditorImage = function ( sRawHTML ) {
      ...
      setPowerPlugin_AdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function ( e ) {
          ...
          oPowerPlugin_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
          // Assign a custom select object
          wp.media.view.MediaFrame.Select = fExternalSource ? getPowerPlugin_AdminPageFrameworkCustomMediaUploaderSelectObject() : oPowerPlugin_AdminPageFrameworkOriginalImageUploaderSelectObject;
          ...
          _oCustomImageUploader.on( 'close', function () {
            ...
            if ( typeof (_oImage) !== 'undefined' ) {
              ...
              _oCustomImageUploader.state().get( 'selection' ).each( function ( oAttachment, iIndex ) {
                ...
                var _oFieldContainer = 'undefined' === typeof _oNewField
                  ? $( '#' + sInputID ).closest( '.power-plugin-field' )
                  : _oNewField;
                _oNewField = $( this ).addPowerPlugin_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oPowerPlugin_AdminPageFrameworkOriginalImageUploaderSelectObject;
    ...
    $().registerPowerPlugin_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Bind the event.
          var _oFieldContainer = oCloned.closest( '.power-plugin-field' );
          ...
          setPowerPlugin_AdminPageFrameworkImageUploader(
    ...
    $( '.select_image.button' ).each( function() {
      setPowerPlugin_AdminPageFrameworkImageUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
    } );
    // Remove buttons
