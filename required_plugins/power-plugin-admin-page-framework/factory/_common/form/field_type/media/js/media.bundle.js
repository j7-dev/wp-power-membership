...
var apfMedia = PowerPlugin_AdminPageFrameworkMediaFieldType;
...
(function ( $ ) {
  ...
  var setPowerPlugin_AdminPageFrameworkMediaUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfMedia.hasMediaUploader ) {
       ...
       */
      setPowerPlugin_AdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMedia.on( 'click', function () {
          ...
          window.send_to_editor = hfPowerPlugin_AdminPageFrameworkSendToEditorMedia;
      ...
      var hfPowerPlugin_AdminPageFrameworkSendToEditorMedia = function ( sRawHTML, param ) {
      ...
      setPowerPlugin_AdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMediaButton.on( 'click', function ( e ) {
          ...
          oPowerPlugin_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;

          // Assign a custom select object.
          wp.media.view.MediaFrame.Select = fExternalSource ? getPowerPlugin_AdminPageFrameworkCustomMediaUploaderSelectObject() : oPowerPlugin_AdminPageFrameworkOriginalMediaUploaderSelectObject;
          ...
          _oMediaUploader.on( 'close', function () {
            ...
            wp.media.view.MediaFrame.Select = oPowerPlugin_AdminPageFrameworkOriginalMediaUploaderSelectObject;
    ...
    $( document ).ready( function () {
      ...
      $( 'a.select_media.button' ).each( function() {
        setPowerPlugin_AdminPageFrameworkMediaUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
      } );
      ...
      $().registerPowerPlugin_AdminPageFrameworkCallbacks( {
          ...
          repeated_field: function ( oCloned, aModel ) {
            ...
            setPowerPlugin_AdminPageFrameworkMediaUploader(
