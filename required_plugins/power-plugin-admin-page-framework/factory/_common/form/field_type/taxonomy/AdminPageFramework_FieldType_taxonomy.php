...
class PowerPlugin_AdminPageFramework_FieldType_taxonomy extends PowerPlugin_AdminPageFramework_FieldType_checkbox {
    ...
    {
        return array( array( 'handle_id' => 'power-plugin-field-type-taxonomy', 'src' => dirname(__FILE__) . '/js/taxonomy.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'power-plugin-script-form-main' ), 'translation_var' => 'PowerPlugin_AdminPageFrameworkFieldTypeTaxonomy', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array(), ), ), );
    }
