...
(function($){
  ...
  var apfTaxonomy = PowerPlugin_AdminPageFrameworkFieldTypeTaxonomy;
  ...
  $( document ).ready( function(){
    ...
    /* For tabs */
    var enablePowerPlugin_AdminPageFrameworkTabbedBox = function ( nodeTabBoxContainer ) {
    ...
    enablePowerPlugin_AdminPageFrameworkTabbedBox( $( '.tab-box-container' ) );
    ...
    $().registerPowerPlugin_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Initialize
          enablePowerPlugin_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
