...
abstract class PowerPlugin_AdminPageFramework_FieldType_Base extends PowerPlugin_AdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName='admin_page_framework', $asFieldTypeSlug=null, $oMsg=null, $bAutoRegister=true)
    {
        ...
        $this->oMsg = $oMsg ? $oMsg : PowerPlugin_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset)
    {
        ...
        $_oFieldset = new PowerPlugin_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    {
        wp_enqueue_media();
        wp_enqueue_script('power-plugin-script-form-media-uploader');
    }
