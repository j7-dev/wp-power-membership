...
(function($){
  ...
  /** global: PowerPlugin_AdminPageFrameworkFieldTypeTextArea */
  var apfTextArea = PowerPlugin_AdminPageFrameworkFieldTypeTextArea;
  ...
  $( document ).ready( function(){
    ...
    var updateFoundEditors = function ( oElements ) {
      ...
      oElements.each( function ( iIndex ) {
        ...
        var oSettings = $().getPowerPlugin_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );
    ...
    $().registerPowerPlugin_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          var _oSettings = $().getPowerPlugin_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );

          // Elements
          var _oField = oCloned.closest( '.power-plugin-field' );
        ...
        stopped_sorting_fields: function ( oSortedFields, sFieldType, sFieldsTagID, iCallType ) {
          ...
          // Update the editor.
          setTimeout( function () {
            var _oFields = oSortedFields.children( '.power-plugin-field' );
        ...
        stopped_sorting_sections: function ( oSections ) {
          ...
          setTimeout( function () {
            var _oFields = $( oSections ).find( '.power-plugin-field' );
            updateFoundEditors( _oFields );
          }, 100 );
        ...
        saved_widget: function ( oWidget ) {
          ...
          $( oWidget ).find( '.power-plugin-field' ).each( function ( iIndex ) {
            ...
            // Store the settings.
            $().storePowerPlugin_AdminPageFrameworkInputOptions(
              oWrap.attr( 'data-id' ),
              {
    ...
    // Initialize
    $( '.power-plugin-textarea-data-input' ).each( function(){
