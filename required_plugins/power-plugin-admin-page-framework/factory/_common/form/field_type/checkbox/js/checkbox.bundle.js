...
(function($){
  ...
  var apfCheckBox = PowerPlugin_AdminPageFrameworkFieldTypeCheckbox;
  ...
  $( document ).ready( function(){
    ...
    $( document ).ready( function(){
      ...
      _body.on( 'click', '.select_all_button_container', function() {
        $( this ).selectAllPowerPlugin_AdminPageFrameworkCheckboxes();
        return false;
      } );
      ...
      _body.on( 'click', '.select_none_button_container', function() {
        $( this ).deselectAllPowerPlugin_AdminPageFrameworkCheckboxes();
        return false;
      } );
    });
