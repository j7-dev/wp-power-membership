...
(function ( $ ) {
  ...
  var apfColor = PowerPlugin_AdminPageFrameworkColorFieldType;

  var registerPowerPlugin_AdminPageFrameworkColorPickerField = function ( osSubjectInput, aOptions ) {
    ...
    var _aDefaults = {
      ...
      change: function ( event, ui ) {
        $( osTargetInput ).trigger( 'power-plugin_field_type_color_changed' );
      ...
      clear: function ( event, ui ) {
        $( osTargetInput ).trigger( 'power-plugin_field_type_color_cleared' );
  ...
  $( document ).ready( function () {
    ...
    // Initialization
    $( '.power-plugin-field-color-picker' ).each( function () {
      registerPowerPlugin_AdminPageFrameworkColorPickerField( $( this ).data( 'input_id' ) );
    } );
    ...
    $().registerPowerPlugin_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          oCloned.find( 'input.input_color' ).each( function ( iIterationIndex ) {
            ...
            registerPowerPlugin_AdminPageFrameworkColorPickerField( _oNewColorInput );
