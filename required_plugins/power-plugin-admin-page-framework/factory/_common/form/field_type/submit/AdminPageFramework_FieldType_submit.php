...
class PowerPlugin_AdminPageFramework_FieldType_submit extends PowerPlugin_AdminPageFramework_FieldType {
    ...
    {
        return array( array( 'handle_id' => 'power-plugin-submit-field-type', 'src' => dirname(__FILE__) . '/js/submit.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', ), ), );
    }
    ...
    {
        return array( 'style' => $aField[ 'label_min_width' ] || '0' === ( string ) $aField[ 'label_min_width' ] ? "min-width:" . $this->getLengthSanitized($aField[ 'label_min_width' ]) . ";" : null, 'class' => 'power-plugin-input-label-container' . ' power-plugin-input-button-container' . ' power-plugin-input-container', );
    }
