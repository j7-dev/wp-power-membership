...
abstract class PowerPlugin_AdminPageFramework_Form_View___Fieldset_Base extends PowerPlugin_AdminPageFramework_Form_Utility {
    ...
    {
        return $this->uniteArrays($aFieldset, $this->_getFieldTypeDefaultArguments($aFieldset[ 'type' ], $aFieldTypeDefinitions) + PowerPlugin_AdminPageFramework_Form_Model___Format_Fieldset::$aStructure);
    }
    ...
    protected function _getRepeatableFieldButtons($sFieldsContainerID, $iFieldCount, $aSettings)
    {
        ...
        $_oFormatter = new PowerPlugin_AdminPageFramework_Form_Model___Format_RepeatableField($_aSettings, $this->oMsg);
    ...
    {
        $_aContainerAttributes = array( 'class' => $this->getClassAttribute('power-plugin-repeatable-field-buttons', ! empty($aArguments[ 'disabled' ]) ? 'disabled' : ''), );
