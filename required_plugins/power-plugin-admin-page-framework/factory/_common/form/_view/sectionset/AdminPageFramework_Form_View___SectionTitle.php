...
class PowerPlugin_AdminPageFramework_Form_View___SectionTitle extends PowerPlugin_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getToolTip($_aSectionset)
    {
        ...
        $_oToolTip = new PowerPlugin_AdminPageFramework_Form_View___ToolTip($_aSectionset[ 'tip' ], $_sSectionTitleTagID);
    ...
    private function _getCollapseButton($aCollapsible)
    {
        ...
        return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='power-plugin-collapsible-button power-plugin-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='power-plugin-collapsible-button power-plugin-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
    }
    ...
    private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions)
    {
        ...
        foreach ($aFieldsets as $_aFieldset) {
            ...
            $_oFieldsetOutputFormatter = new PowerPlugin_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);
