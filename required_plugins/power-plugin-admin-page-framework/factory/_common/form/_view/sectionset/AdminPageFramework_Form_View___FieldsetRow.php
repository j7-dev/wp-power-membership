...
class PowerPlugin_AdminPageFramework_Form_View___FieldsetRow extends PowerPlugin_AdminPageFramework_Form_View___FieldsetTableRow {
    ...
    public function get()
    {
        ...
        $_oFieldrowAttribute = new PowerPlugin_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
