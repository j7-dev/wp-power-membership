...
class PowerPlugin_AdminPageFramework_Form_Model___Format_RepeatableSection extends PowerPlugin_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct()
    {
        ...
        $this->_oMsg = $_aParameters[ 1 ] ? $_aParameters[ 1 ] : PowerPlugin_AdminPageFramework_Message::getInstance();
    }
    public function get()
    {
