...
class PowerPlugin_AdminPageFramework_Form_Model___FormatSectionset extends PowerPlugin_AdminPageFramework_Form_Utility {
    ...
    public function get()
    {
        ...
        $_oCollapsibleArgumentFormatter = new PowerPlugin_AdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset[ 'collapsible' ], $_aSectionset[ 'title' ]);
