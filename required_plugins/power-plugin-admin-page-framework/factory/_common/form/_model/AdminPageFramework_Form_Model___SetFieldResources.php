...
class PowerPlugin_AdminPageFramework_Form_Model___SetFieldResources extends PowerPlugin_AdminPageFramework_Form_Base {
    ...
    private function ___setCommonFormJavaScriptScripts()
    {
        ...
        $this->aResources[ 'src_scripts' ][] = array( 'handle_id' => 'power-plugin-script-form-main', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/js/form.bundle.js', 'dependencies' => array( 'jquery', 'wp-pointer', 'jquery-ui-sortable' ), 'in_footer' => true, 'version' => PowerPlugin_AdminPageFramework_Registry::VERSION, 'translation' => $_aData, 'translation_var' => 'PowerPlugin_AdminPageFrameworkScriptFormMain', );
        $this->aResources[ 'register' ][ 'scripts' ][] = array( 'handle_id' => 'power-plugin-script-form-collapsible-sections', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/js/form-collapsible-sections.js', 'dependencies' => array( 'jquery', 'jquery-ui-accordion', 'power-plugin-script-form-main' ), 'in_footer' => true, 'version' => PowerPlugin_AdminPageFramework_Registry::VERSION, );
        if (function_exists('wp_enqueue_media')) {
            $this->aResources[ 'register' ][ 'scripts' ][] = array( 'handle_id' => 'power-plugin-script-form-media-uploader', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/js/form-media-uploader.js', 'dependencies' => array( 'jquery', 'power-plugin-script-form-main' ), 'in_footer' => false, 'version' => PowerPlugin_AdminPageFramework_Registry::VERSION, 'translation_var' => 'PowerPlugin_AdminPageFrameworkScriptFormMediaUploader', 'translation' => array( 'messages' => array( 'returnToLibrary' => $this->oMsg->get('return_to_library'), 'select' => $this->oMsg->get('select'), 'insert' => $this->oMsg->get('insert'), ), ), );
        }
    }
    private function ___setCommonFormExternalStylesheets()
    {
        $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'power-plugin-form', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form/form.css', );
        $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'power-plugin-form-ie', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_ie/form_ie.css', 'conditional' => 'IE', );
        $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'wp-pointer', );
        if (version_compare($GLOBALS[ 'wp_version' ], '5.3', '>=')) {
            $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'power-plugin-form-5_3-or-above', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_5_3_or_above/form_5_3_or_above.css', );
        }
        if (version_compare($GLOBALS[ 'wp_version' ], '4.7', '>=')) {
            $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'power-plugin-form-4_7-or-above', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_4_7_or_above/form_4_7_or_above.css', );
        }
        if (version_compare($GLOBALS[ 'wp_version' ], '3.8', '<')) {
            $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'power-plugin-form-4_8-below', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_3_8_below/form_3_8_below.css', );
        }
        if (version_compare($GLOBALS[ 'wp_version' ], '3.8', '>=')) {
            $this->aResources[ 'src_styles' ][] = array( 'handle_id' => 'power-plugin-form-3_8-or-above', 'src' => PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form_3_8_or_above/form_3_8_or_above.css', );
        }
    }
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition)
    {
        ...
        new PowerPlugin_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments[ 'structure_type' ]);
        $_oFieldTypeResources = new PowerPlugin_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
