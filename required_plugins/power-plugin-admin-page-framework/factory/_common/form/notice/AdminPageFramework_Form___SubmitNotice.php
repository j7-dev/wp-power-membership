...
class PowerPlugin_AdminPageFramework_Form___SubmitNotice extends PowerPlugin_AdminPageFramework_FrameworkUtility {
    ...
    {
        new PowerPlugin_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices)
    {
        ...
        foreach (array_filter(( array ) $aNotices, 'is_array') as $_aNotice) {
            ...
            new PowerPlugin_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
