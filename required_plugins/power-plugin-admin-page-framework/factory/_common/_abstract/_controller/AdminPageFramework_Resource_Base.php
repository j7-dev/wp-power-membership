...
abstract class PowerPlugin_AdminPageFramework_Resource_Base extends PowerPlugin_AdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'power-plugin-style';
    protected $_sClassSelector_Script = 'power-plugin-script';
    ...
    {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array( "style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}", ), PowerPlugin_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName)
    {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array( "script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}", ), PowerPlugin_AdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle()
    {
        ...
        $this->_printCommonStyles('power-plugin-style-common', get_class());
    ...
    public function _replyToAddScript()
    {
        ...
        $this->_printCommonScripts('power-plugin-script-common', get_class());
    ...
    public function _replyToEnqueueCommonStyles()
    {
        ...
        $this->_addEnqueuingResourceByType(PowerPlugin_AdminPageFramework_Registry::$sDirPath . '/factory/_common/asset/css/common.css', array( 'version' => PowerPlugin_AdminPageFramework_Registry::VERSION, ), 'style');
    }
