...
abstract class PowerPlugin_AdminPageFramework_Factory_View extends PowerPlugin_AdminPageFramework_Factory_Model {
    public function __construct($oProp)
    {
        parent::__construct($oProp);
        new PowerPlugin_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
