...
abstract class PowerPlugin_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array( 'oForm' => 'PowerPlugin_AdminPageFramework_Form_', 'oPageLoadInfo' => 'PowerPlugin_AdminPageFramework_PageLoadInfo_', 'oResource' => 'PowerPlugin_AdminPageFramework_Resource_', 'oHelpPane' => 'PowerPlugin_AdminPageFramework_HelpPane_', 'oLink' => 'PowerPlugin_AdminPageFramework_Link_', );
    private $_aSubClassNames = array( 'oProp' => null, 'oDebug' => 'PowerPlugin_AdminPageFramework_Debug', 'oUtil' => 'PowerPlugin_AdminPageFramework_FrameworkUtility', 'oMsg' => 'PowerPlugin_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null, );
    ...
    {
        trigger_error(PowerPlugin_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString()
    {
        return PowerPlugin_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
