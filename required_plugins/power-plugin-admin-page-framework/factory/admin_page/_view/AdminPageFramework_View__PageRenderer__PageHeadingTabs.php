...
class PowerPlugin_AdminPageFramework_View__PageRenderer__PageHeadingTabs extends PowerPlugin_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    {
        $_oTabBar = new PowerPlugin_AdminPageFramework_TabNavigationBar($aPages, $sCurrentPageSlug, $sTag, array( ), array( 'format' => array( $this, '_replyToFormatNavigationTabItem_PageHeadingTab' ), ));
        $_sTabBar = $_oTabBar->get();
        return $_sTabBar ? "<div class='power-plugin-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
