...
class PowerPlugin_AdminPageFramework_View__Resource extends PowerPlugin_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    {
        $_oFormatter = new PowerPlugin_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    {
        $_oFormatter = new PowerPlugin_AdminPageFramework_Format_PageResource_Script($asPageScript);
