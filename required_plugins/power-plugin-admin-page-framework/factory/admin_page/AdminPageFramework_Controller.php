...
abstract class PowerPlugin_AdminPageFramework_Controller extends PowerPlugin_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector='error', $sID='')
    {
        ...
        new PowerPlugin_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[ $sID ][ 'sMessage' ], $this->oProp->aAdminNotices[ $sID ][ 'aAttributes' ], array( 'should_show' => array( $this, 'isInThePage' ), ));
    }
    ...
    {
        return PowerPlugin_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
