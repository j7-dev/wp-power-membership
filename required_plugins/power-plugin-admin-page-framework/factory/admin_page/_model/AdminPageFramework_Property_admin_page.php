...
class PowerPlugin_AdminPageFramework_Property_admin_page extends PowerPlugin_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability='manage_options', $sTextDomain='power-plugin')
    {
        ...
        $GLOBALS[ 'aPowerPlugin_AdminPageFramework' ][ 'aPageClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aPowerPlugin_AdminPageFramework', 'aPageClasses' ));
        $GLOBALS[ 'aPowerPlugin_AdminPageFramework' ][ 'aPageClasses' ][ $sClassName ] = $oCaller;
