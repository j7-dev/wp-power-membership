...
class PowerPlugin_AdminPageFramework_Model__FormSubmission__Validator__Export extends PowerPlugin_AdminPageFramework_Model__FormSubmission__Validator__Import {
    ...
    {
        $_oExport = new PowerPlugin_AdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array( '__export' ))), $this->oFactory->oProp->sClassName);
