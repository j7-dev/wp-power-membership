...
class PowerPlugin_AdminPageFramework_Model__FormSubmission__Validator__ContactForm extends PowerPlugin_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function ___sendEmail($aInputs, $sPressedInputNameFlat, $sSubmitSectionID)
    {
        ...
        $_oEmail = new PowerPlugin_AdminPageFramework_FormEmail($_aEmailOptions, $aInputs, $sSubmitSectionID);
        $_bSent = $_oEmail->send();
