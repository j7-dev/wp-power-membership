...
class PowerPlugin_AdminPageFramework_FormEmail extends PowerPlugin_AdminPageFramework_FrameworkUtility {
    ...
    public function send()
    {
        ...
        do_action('power-plugin_action_before_sending_form_email', $_aEmailOptions, $_aInputs, $_sSubmitSectionID);
        ...
        do_action('power-plugin_action_after_sending_form_email', $_bSent, $_aEmailOptions);
