...
class PowerPlugin_AdminPageFramework_ExportOptions extends PowerPlugin_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
    ...
    private function _outputDataByType($vData, $sFormatType)
    {
        switch (strtolower($sFormatType)) { case 'text': if (in_array(gettype($vData), array( 'array', 'object' ))) {
            echo PowerPlugin_AdminPageFramework_Debug::get($vData, null, false);
