...
abstract class PowerPlugin_AdminPageFramework_Controller_Form extends PowerPlugin_AdminPageFramework_View_Form {
    ...
    public function getValue()
    {
        ...
        return PowerPlugin_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
