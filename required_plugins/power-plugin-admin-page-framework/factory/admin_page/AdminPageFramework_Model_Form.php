...
abstract class PowerPlugin_AdminPageFramework_Model_Form extends PowerPlugin_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    {
        new PowerPlugin_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
