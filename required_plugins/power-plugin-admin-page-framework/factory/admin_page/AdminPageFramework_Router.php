...
abstract class PowerPlugin_AdminPageFramework_Router extends PowerPlugin_AdminPageFramework_Factory {
    public $oProp;
    public $oForm;
    ...
    public function _replyToLoadComponentsForAjax()
    {
        ...
        new PowerPlugin_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
