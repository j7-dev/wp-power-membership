...
class PowerPlugin_AdminPageFramework_Property_page_meta_box extends PowerPlugin_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability='manage_options', $sTextDomain='power-plugin', $sStructureType='page_meta_box')
    {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS[ 'aPowerPlugin_AdminPageFramework' ][ 'aMetaBoxForPagesClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aPowerPlugin_AdminPageFramework', 'aMetaBoxForPagesClasses' ));
        $GLOBALS[ 'aPowerPlugin_AdminPageFramework' ][ 'aMetaBoxForPagesClasses' ][ $sClassName ] = $oCaller;
    }
    ...
    {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array( 'aPowerPlugin_AdminPageFramework', 'aPageClasses' ));
