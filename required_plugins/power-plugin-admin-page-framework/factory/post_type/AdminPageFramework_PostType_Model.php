...
abstract class PowerPlugin_AdminPageFramework_PostType_Model extends PowerPlugin_AdminPageFramework_PostType_Router {
    public function __construct($oProp)
    {
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new PowerPlugin_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType()
    {
        ...
        new PowerPlugin_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
