...
abstract class PowerPlugin_AdminPageFramework_PostType_View extends PowerPlugin_AdminPageFramework_PostType_Model {
    ...
    public function _replyToPrintStyle()
    {
        ...
        if (! empty($_sStyle)) {
            echo "<style type='text/css' id='power-plugin-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
        $this->oProp->sStyle = '';
    }
