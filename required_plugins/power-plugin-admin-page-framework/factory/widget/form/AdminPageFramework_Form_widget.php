...
class PowerPlugin_AdminPageFramework_Form_widget extends PowerPlugin_AdminPageFramework_Form {
    ...
    {
        $_oCSS = new PowerPlugin_AdminPageFramework_Form_View___CSS_widget;
