...
abstract class PowerPlugin_AdminPageFramework_TermMeta_Model extends PowerPlugin_AdminPageFramework_TermMeta_Router {
    ...
    {
        $_oMetaData = new PowerPlugin_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
