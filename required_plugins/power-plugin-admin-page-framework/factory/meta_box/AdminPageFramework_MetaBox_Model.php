...
abstract class PowerPlugin_AdminPageFramework_MetaBox_Model extends PowerPlugin_AdminPageFramework_MetaBox_Router {
    ...
    {
        $_oMetaData = new PowerPlugin_AdminPageFramework_MetaBox_Model___PostMeta($this->___getPostID(), $this->oForm->aFieldsets);
