...
abstract class PowerPlugin_AdminPageFramework_UserMeta extends PowerPlugin_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability='read', $sTextDomain='power-plugin')
    {
