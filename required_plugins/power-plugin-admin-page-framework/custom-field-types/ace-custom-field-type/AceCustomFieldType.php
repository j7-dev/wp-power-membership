<?php
/**
 * PowerPlugin_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'PowerPlugin_AceCustomFieldType' ) ) :
class PowerPlugin_AceCustomFieldType extends PowerPlugin_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.power-plugin-field' ).nextAll().andSelf().each( function( iIndex ) {
