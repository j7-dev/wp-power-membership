...
if ( ! class_exists( 'PowerPlugin_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class PowerPlugin_ToggleCustomFieldType extends PowerPlugin_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.power-plugin-field' )
                    .children( '.power-plugin-checkbox-container-toggle' )
                    .hide();
