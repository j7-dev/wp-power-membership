<?php
if ( ! class_exists( 'PowerPlugin_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class PowerPlugin_GitHubCustomFieldType extends PowerPlugin_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='power-plugin-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='power-plugin-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'power-plugin' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'power-plugin' );
                case 'star':
                    return __( 'Star', 'power-plugin' );
                case 'fork':
                    return __( 'Fork', 'power-plugin' );
                case 'issue':
                    return __( 'Issue', 'power-plugin' );
                default:
                    return '';
            }                 
