...
if ( ! class_exists( 'PowerPlugin_NoUISliderCustomFieldType' ) ) :
/**
 ...
 */
class PowerPlugin_NoUISliderCustomFieldType extends PowerPlugin_AdminPageFramework_FieldType_text {
